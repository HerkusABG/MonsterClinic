...
// making the medicine availability random for the player, so he cant spam the self treatment
	...
	private void _on_button_pressed()
	{
        ...
        if (currentIndex < dialogues[currentNPC].Length)
        {
    ...
    public void DiologText()
    {
        ...
        else if (currentNPC == 1)
        {
            ...
            {
            "...",
            "My name is" + StoryPatientList.Database["Karl"].name,
            StoryPatientList.Database["Karl"].entrySpeech
            };

            // Label declares which persons speaks
            Name_label.Text = StoryPatientList.Database["Karl"].name;
        }
    }
